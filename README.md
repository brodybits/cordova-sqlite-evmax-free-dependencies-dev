# cordova-sqlite-evmax-free-dependencies EU support
...
- <https://github.com/brodybits/android-sqlite-evmax-ndk-driver-free/tree/evmax-eu-support-2023> - with GPL v3 or commercial license options
- [SQLite (sqlite.org)](https://sqlite.org/) version `3.41.1` - public domain
...
- [brodybits / sqlite3-eu](https://github.com/brodybits/sqlite3-eu) (MIT license)

This project provides the following dependencies needed to build Cordova SQLite evmax plugin versions:
...
- `sqlc-evmax-ndk-driver.jar` - android-sqlite-evmax-ndk-driver-free NDK JAR built with SQLite amalgamation and other sources listed above, with the following option flags:
